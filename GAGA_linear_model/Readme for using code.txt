...
Experiment_timeCost.R for the time cost simulation.

We use the Package ncvreg (Breheny and Huang (2011)) in R for the adaptive LASSO, the SCAD, and
the MCP. All the experiments in R adopt the OpenBlas for performing basic vector and matrix operations.