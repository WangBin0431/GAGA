#设置工作路径
setwd("F:/投稿论文/JRSSB/GAGA_numericalexperiment/Experiment")
...
ERR_ACC=data.frame(ERR,ACC,Algorithms)#用来画ROC曲线图
...
ERR_ACC2=data.frame(ERR2,ACC2,Algorithms)#用来画箱盒图

g2=ggplot(ERR_ACC2, aes(x=Algorithms, y=ERR2,fill=Algorithms))+ylab("ERR") + geom_boxplot()#ERR箱盒图
g2

g3=ggplot(ERR_ACC2, aes(x=Algorithms, y=ACC2,fill=Algorithms))+xlab("Algorithms")+ylab("ACC") + geom_boxplot()#ACC箱盒图
g3
